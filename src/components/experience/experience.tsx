...
export function Experience() {
	return (
		<ExperienceContainer id={"experience"} className={"fade-in"}>
			<ExperienceListContainer>
				...
				<ExperienceContent className={"navy-text page-content"}>
					<ExperienceList className={"mb-2"}>
						<ExperienceListItem>5 years as a professional full-stack software developer has given me a strong foundation of application development best practices.</ExperienceListItem>
